...
### ☁️ Cloud & Backend (클라우드 & 백엔드)

- AWS API Gateway (connects Flutter app with serverless backend) (Flutter 앱과 서버리스 백엔드 연동)
- AWS Lambda (backend logic using JavaScript) (백엔드 로직, JavaScript 기반)
- AWS RDS (MySQL – user and app data storage) (MySQL – 사용자 및 앱 데이터 저장)
- AWS S3 (image and static asset storage) (이미지 및 정적 리소스 저장)
- AWS SageMakerAI ProcessingJob (data preprocessing and machine learning) (데이터 전처리 및 머신러닝)
